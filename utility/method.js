...
/*validation  */
//kiem tra rong
 export  let  kiemTraRong = (value,id) => {
    if(value.trim() === '' ) {
...
//kiem tra ten 
 export let kiemTraTen =(value, id) => {
...
//kiem tra khoang 
export  let  kiemTraKhoang =(value, id, min, max)=> {
    if (value < min || value > max) {
        document.querySelector(`#${id}`).innerHTML = `Grade range : ${min}- ${max}`
        return false;
    }
    document.querySelector(`#${id}`).innerHTML = '';
    return true;
...
//kiem tra email
 export let kiemTraEmail= (value, id) => {
